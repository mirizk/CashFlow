...
import com.cashflow.BuildConfig.APPLICATION_ID
import com.cashflow.data.enums.BudgetType
import com.cashflow.databinding.FragmentBudgetBinding
...
class BudgetFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        context?.let {
            if (!NotificationManagerCompat.getEnabledListenerPackages(it).contains(APPLICATION_ID))
